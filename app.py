...
if parking_code == 'TAJ' or parking_code == 'Billiards' or parking_code == 'Dyson':
  if 'slice_pct' not in st.session_state:
    st.session_state.slice_pct = 35
if 'client_pct' not in st.session_state:
    st.session_state.client_pct = 65
elif parking_code == 'CP' or parking_code == 'CPUpperLot':
  if 'slice_pct' not in st.session_state:
    st.session_state.slice_pct = 45
  if 'client_pct' not in st.session_state:
    st.session_state.client_pct = 55
else :
  if 'slice_pct' not in st.session_state:
    st.session_state.slice_pct = 70
  if 'client_pct' not in st.session_state:
    st.session_state.client_pct = 30
