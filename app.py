...
# --- Initialize session state for sliders BEFORE the widgets are created ---
# (Setting a widget-keyed session_state value after the widget exists raises an error.)
if parking_code in ('TAJ', 'Billiards', 'Dyson'):
    default_slice = 35
...
if 'slice_pct' not in st.session_state:
    st.session_state.slice_pct = default_slice
if 'client_pct' not in st.session_state:
    st.session_state.client_pct = 100 - default_slice
