    ...
    if not all(required_files):
        ...
        with st.spinner("Crunching the numbers... Please wait..."):
            try:
                ...
                else if parking_code == "CP" or parking_code == "CPUpperLot":
                ...
                if parking_code == "BCW":
                  ...
                  metrics = ['Gross Revenue', 'Service Fee', 'Credit Card Fee', 'Subtotal', 'Parking Net Revenue']
                  values = [gross, service, credit, subtotal, net]
                else:
