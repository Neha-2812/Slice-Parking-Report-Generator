...
st.markdown("""
    ...
    .main-header {font-size: 2.4rem; font-weight: 700; color: #1E293B; margin-bottom: 5px; display: flex; align-items: center;}
    .sub-header {font-size: 1.1rem; font-weight: 400; color: #64748B; margin-bottom: 25px;}
    .stButton>button {background-color: #2563EB; color: white; border-radius: 8px; font-weight: 600; height: 50px; transition: all 0.3s ease; border: none; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.2);}
    .stButton>button:hover {background-color: #1D4ED8; color: white; box-shadow: 0 10px 15px -3px rgba(37, 99, 235, 0.3); transform: translateY(-2px);}
    ...
    .metric-title {font-size: 0.9rem; font-weight: 600; color: #64748B; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px;}
    .metric-value {font-size: 2rem; font-weight: 700; color: #0F172A; margin: 0;}
    .metric-highlight {color: #059669;}
    
    .section-title {font-size: 1.5rem; font-weight: 600; color: #1E293B; margin-top: 30px; margin-bottom: 15px; border-bottom: 2px solid #E2E8F0; padding-bottom: 5px;}
    </style>
        ...
        with st.spinner("Crunching the numbers... Please wait..."):
            try:
                ...
                <div style='display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 20px;'>
                    ...
                    <div class='metric-card' style='flex: 1; min-width: 200px; border-bottom: 4px solid #059669;'>
                ...
                st.markdown("<h5 style='font-weight: 600; color: #334155; margin-top: 20px;'>Detailed Summary Breakdown</h5>", unsafe_allow_html=True)
