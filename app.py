            ...
            try:
                ...
                with pd.ExcelWriter(buffer, engine='openpyxl') as writer:
                    ...
                    if parking_code == 'BCW' and 'bcws_all_rows' in locals() and not bcws_all_rows.empty:
                        ...
                        sub_summary_data = {'': ['Sum of Total Amount', 'Sum of Payment Gateway Fee', 'Sum of Service Fee', 'Sum of City Tax', 'Sub Total', 'Tech Fee', 'Net Total'], ' ': [''] * 5, '  ': [float(bcws_all_rows['Total Amount'].sum()), float(bcws_all_rows['Payment Gateway Fee'].sum()), float(bcws_all_rows['Service Fee'].sum()), float(bcws_all_rows['City Tax'].sum()), total_calc, float(total_calc * 0.10), net_calc]}
